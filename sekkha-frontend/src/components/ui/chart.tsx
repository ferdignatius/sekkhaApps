  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-white/95 p-2.5 text-xs shadow-xl backdrop-blur-md dark:bg-slate-900/95 dark:text-white",
          className
        )}
      >
