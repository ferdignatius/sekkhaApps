...
export { SchoolPage } from "./internal/components/SchoolPage"
  ...
  configureSections: [
      ...
      items: [
        {
          ...
          to: "/configure/master/school",
          icon: "GraduationCap",
          hasRoute: true,
        },
        {
          label: "Event Categories",
          to: "/configure/master/event-type",
          icon: "Tag",
          hasRoute: true,
        },
        {
          label: "Time Presets",
          to: "/configure/master/event-time",
          icon: "Clock",
          hasRoute: true,
        },
        {
          label: "Attendance Badges",
          to: "/configure/master/attendance-badge",
          icon: "Award",
          hasRoute: true,
        },
      ],
    },
    {
      ...
      items: [
        {
          label: "Achievements",
          to: "/configure/master/achievement",
          icon: "Trophy",
          hasRoute: true,
        },
        {
          label: "Master Badges",
          to: "/configure/master/badge",
          icon: "Award",
          hasRoute: true,
        },
        {
          label: "Member Levels",
          to: "/configure/master/level",
          icon: "Zap",
          hasRoute: true,
        },
      ],
      ...
      items: [
        {
          ...
          to: "/configure/rules/season",
          icon: "Trophy",
          hasRoute: true,
        },
        {
          label: "Point Rules",
          to: "/configure/rules/points",
          icon: "Zap",
          hasRoute: true,
        },
      ],
      ...
      items: [
        {
          ...
          to: "/configure/early-warning/threshold",
          icon: "Bell",
          hasRoute: true,
        },
      ],
