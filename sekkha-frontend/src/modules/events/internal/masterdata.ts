...
export const DEFAULT_CATEGORIES: EventCategoryItem[] = [
  {
    ...
    is_active: true,
    colorHex: "#0284c7",
    autofillTitle: "Routine Sunday Service",
    autofillLocation: "Main Dhammasala Vihara Sekkha",
    autofillDesc: "Routine service session with Vihara Sekkha community.",
  ...
  },
  {
    ...
    is_active: true,
    colorHex: "#d97706",
    autofillTitle: "Special Festival Service",
    autofillLocation: "Vihara Sekkha",
    autofillDesc: "Major holiday celebration and special puja.",
    target_roles: ["admin", "pengurus", "aktivis", "umat"],
  },
  {
    id: "cat-3",
    ...
    is_active: true,
    colorHex: "#9333ea",
    autofillTitle: "Spiritual Character Retreat",
    autofillLocation: "Vihara Meditation Pavilion",
    autofillDesc: "Intensive retreat and spiritual cultivation.",
    target_roles: ["admin", "pengurus", "aktivis", "umat"],
  },
  {
    id: "cat-4",
    ...
    is_active: true,
    colorHex: "#059669",
    autofillTitle: "Group Meditation Session",
    autofillLocation: "Meditation Hall",
    autofillDesc: "Bhavana practice and mindfulness training.",
    target_roles: ["admin", "pengurus", "aktivis", "umat"],
  },
  {
    id: "cat-5",
    ...
    is_active: true,
    colorHex: "#e11d48",
    autofillTitle: "Community Social Service",
    autofillLocation: "Vihara Sekkha",
    autofillDesc: "Charity drives and community outreach.",
    target_roles: ["admin", "pengurus", "aktivis", "umat"],
  },
  {
    id: "cat-6",
    ...
    is_active: true,
    colorHex: "#4f46e5",
    autofillTitle: "General Vihara Activity",
    autofillLocation: "Vihara Sekkha",
    autofillDesc: "General community event.",
    target_roles: ["admin", "pengurus", "aktivis", "umat"],
  },
]
...
export const DEFAULT_BADGES: AttendanceBadge[] = [
  ...
  {
    id: "panitia",
    name: "Committee / Volunteer",
    points: 50,
    color: "bg-purple-50/90 text-purple-800 border-purple-200/80",
    is_active: true,
  },
  {
    id: "pemusik",
    name: "Musician / Audio",
    points: 40,
    color: "bg-rose-50/90 text-rose-800 border-rose-200/80",
    is_active: true,
  },
  {
    id: "kebersihan",
...
export const DEFAULT_TIME_PRESETS: EventTimePresetItem[] = [
  {
    id: "etp-1",
    label: "08:00 (Morning Puja)",
    time: "08:00",
    day_of_week: -1,
    description: "Morning Puja service for members & youth",
    is_active: true,
    target_category_tags: [],
  },
  {
    id: "etp-2",
    label: "14:00 (Afternoon Service)",
    time: "14:00",
    day_of_week: 0,
    description: "General service & Sunday School (Sunday)",
    is_active: true,
    target_category_tags: [],
  },
  {
    id: "etp-3",
    label: "18:30 (Evening Puja)",
    time: "18:30",
    day_of_week: -1,
    description: "Evening Puja & Meditation session",
    is_active: true,
    target_category_tags: [],
  },
  {
    id: "etp-4",
    label: "19:00 (Dhamma Discussion)",
    time: "19:00",
    day_of_week: 4,
    description: "Dhammasakaccha & Dhamma Study (Thursday)",
    is_active: true,
    target_category_tags: [],
  },
]
...
export function getMasterTimePresets(
  activeOnly = false
): EventTimePresetItem[] {
...
export function getTimePresetsForCategory(
  ...
  return all.filter((t) => {
    if (!t.target_category_tags || t.target_category_tags.length === 0)
      return true
