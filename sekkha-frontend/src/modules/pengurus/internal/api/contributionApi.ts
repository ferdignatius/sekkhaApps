...
const PENGURUS_DATA: Omit<ContributionPerson, "status">[] = [
  {
    ...
    initiativeScore: 14,
    executionScore: 18,
    effectivenessPercent: 87.2,
    presencePercent: 96.0,
    initiativeTrend: 3,
    executionTrend: 4,
    effectivenessTrend: 2.1,
    presenceTrend: 0.5,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    totalMonths: 3,
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 10 },
      { role: "MC", count: 5 },
      { role: "Dokumentasi", count: 3 },
    ],
  },
  {
    id: "p2",
    ...
    initiativeScore: 11,
    executionScore: 14,
    effectivenessPercent: 92.8,
    presencePercent: 98.5,
    initiativeTrend: 2,
    executionTrend: 1,
    effectivenessTrend: 3.4,
    presenceTrend: 1.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    totalMonths: 3,
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 8 },
      { role: "Pengajar Dhamma", count: 6 },
    ],
  },
  {
    id: "p3",
    ...
    initiativeScore: 22,
    executionScore: 26,
    effectivenessPercent: 78.4,
    presencePercent: 94.0,
    initiativeTrend: 6,
    executionTrend: 8,
    effectivenessTrend: -1.2,
    presenceTrend: -2.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    totalMonths: 3,
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 15 },
      { role: "Logistik", count: 8 },
      { role: "MC", count: 3 },
    ],
  },
  {
    ...
    initiativeScore: 9,
    executionScore: 12,
    effectivenessPercent: 91.5,
    presencePercent: 97.0,
    initiativeTrend: 1,
    executionTrend: 2,
    effectivenessTrend: 1.8,
    presenceTrend: 0.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 7,
    executionScore: 10,
    effectivenessPercent: 85.6,
    presencePercent: 92.0,
    initiativeTrend: 0,
    executionTrend: -1,
    effectivenessTrend: -0.5,
    presenceTrend: -3.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 2,
  ...
  },
  {
    ...
    initiativeScore: 6,
    executionScore: 8,
    effectivenessPercent: 89.0,
    presencePercent: 95.5,
    initiativeTrend: 1,
    executionTrend: 2,
    effectivenessTrend: 4.2,
    presenceTrend: 1.5,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    totalMonths: 3,
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 4 },
      { role: "Pendamping Pemuda", count: 4 },
    ],
  },
  {
    id: "p7",
    ...
    initiativeScore: 4,
    executionScore: 5,
    effectivenessPercent: 82.0,
    presencePercent: 88.0,
    initiativeTrend: -2,
    executionTrend: -3,
    effectivenessTrend: -4.0,
    presenceTrend: -5.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 1,
  ...
  },
  {
    ...
    initiativeScore: 8,
    executionScore: 11,
    effectivenessPercent: 90.2,
    presencePercent: 96.5,
    initiativeTrend: 2,
    executionTrend: 3,
    effectivenessTrend: 2.0,
    presenceTrend: 0.5,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    totalMonths: 3,
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 6 },
      { role: "MC", count: 3 },
      { role: "Dokumentasi", count: 2 },
    ],
  },
  {
    id: "p9",
    ...
    presencePercent: 93.0,
    initiativeTrend: 1,
    executionTrend: 0,
    effectivenessTrend: 1.5,
    presenceTrend: -1.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 5,
    executionScore: 7,
    effectivenessPercent: 84.0,
    presencePercent: 90.0,
    initiativeTrend: 0,
    executionTrend: 1,
    effectivenessTrend: 0.5,
    presenceTrend: -2.0,
  ...
  },
  {
    ...
    initiativeScore: 12,
    executionScore: 15,
    effectivenessPercent: 93.5,
    presencePercent: 99.0,
    initiativeTrend: 4,
    executionTrend: 5,
    effectivenessTrend: 3.0,
    presenceTrend: 1.0,
    invitedCount: 0,
    invitedTrend: 0,
    activeMonths: 3,
    ...
    roleBreakdown: [
      { role: "Penanggung Jawab", count: 8 },
      { role: "Pendamping Pemuda", count: 5 },
      { role: "MC", count: 2 },
    ],
  },
  {
    ...
    initiativeScore: 3,
    executionScore: 4,
    effectivenessPercent: 76.0,
    presencePercent: 85.0,
    initiativeTrend: -1,
    executionTrend: -2,
    effectivenessTrend: -3.0,
    presenceTrend: -4.0,
...
const AKTIVIS_DATA: Omit<ContributionPerson, "status">[] = [
  {
    ...
    initiativeScore: 5,
    executionScore: 8,
    effectivenessPercent: 88.0,
    presencePercent: 95.0,
    initiativeTrend: 2,
    executionTrend: 3,
    effectivenessTrend: 5.0,
    presenceTrend: 2.0,
    invitedCount: 24,
    invitedTrend: 8,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 3,
    executionScore: 6,
    effectivenessPercent: 91.2,
    presencePercent: 97.0,
    initiativeTrend: 1,
    executionTrend: 2,
    effectivenessTrend: 3.2,
    presenceTrend: 1.5,
    invitedCount: 18,
    invitedTrend: 5,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 4,
    executionScore: 7,
    effectivenessPercent: 84.5,
    presencePercent: 92.0,
    initiativeTrend: 1,
    executionTrend: 1,
    effectivenessTrend: 1.0,
    presenceTrend: 0.0,
    invitedCount: 12,
    invitedTrend: 3,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 2,
    executionScore: 4,
    effectivenessPercent: 86.0,
    presencePercent: 90.0,
    initiativeTrend: 0,
    executionTrend: 1,
    effectivenessTrend: 2.5,
    presenceTrend: -1.0,
    invitedCount: 15,
    invitedTrend: 4,
    activeMonths: 2,
    ...
    roleBreakdown: [
      { role: "Among", count: 2 },
      { role: "Pendamping Pemuda", count: 2 },
    ],
  },
  {
    id: "a5",
    ...
    initiativeScore: 6,
    executionScore: 9,
    effectivenessPercent: 90.8,
    presencePercent: 96.5,
    initiativeTrend: 3,
    executionTrend: 4,
    effectivenessTrend: 4.5,
    presenceTrend: 1.0,
    invitedCount: 28,
    invitedTrend: 10,
    activeMonths: 3,
  ...
  },
  {
    ...
    initiativeScore: 1,
    executionScore: 3,
    effectivenessPercent: 79.0,
    presencePercent: 82.0,
    initiativeTrend: 0,
    executionTrend: 0,
    effectivenessTrend: -2.0,
    presenceTrend: -5.0,
  ...
  },
  {
    ...
    initiativeScore: 3,
    executionScore: 5,
    effectivenessPercent: 83.5,
    presencePercent: 89.0,
    initiativeTrend: 1,
    executionTrend: 1,
    effectivenessTrend: 0.5,
    presenceTrend: -1.0,
  ...
  },
  {
    ...
    totalMonths: 3,
    roleBreakdown: [
      { role: "Pendamping Pemuda", count: 3 },
      { role: "Among", count: 2 },
      { role: "Dokumentasi", count: 1 },
    ],
  },
  {
    id: "a9",
    name: "Vina Christabel",
    role: "aktivis",
    divisi: "humas",
    avatarInitials: "VC",
    initiativeScore: 2,
...
function deriveStatus(
  p: Omit<ContributionPerson, "status">
...
export async function fetchContributions(
  ...
  const summary: ContributionSummary = {
    ...
    reliableCandidates: allPersons.filter((p) => p.status === "reliable")
      .length,
    overloadedRisk: allPersons.filter((p) => p.status === "overloaded").length,
    promotionReady: allPersons.filter((p) => p.status === "promotion_ready")
      .length,
    avgTeamPresence:
      Math.round(
        (allPersons.reduce((sum, p) => sum + p.presencePercent, 0) /
          allPersons.length) *
          10
      ) / 10,
    totalInvitedByAktivis: aktivisAll.reduce(
      (sum, p) => sum + p.invitedCount,
      0
    ),
  }
