...
export const Route = createFileRoute("/_authenticated/configure/master/school")({
  beforeLoad: ({ context }) => {
  ...
  component: lazyRouteComponent(() => import("@/modules/configure").then(m => ({ default: m.SchoolPage }))),
