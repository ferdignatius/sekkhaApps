...
export function AchievementPage() {
  ...
  function handleSave() {
    ...
    if (editTarget) {
      setAchievements(prev =>
        prev.map(a => a.id === editTarget.id ? { ...a, name, icon, description, condition_type: conditionType, condition_value: conditionValue } : a)
      )
    } else {
  ...
  return (
    <main>
      <PageBreadcrumb items={[{ label: "Beranda", href: "/home" }, { label: "Configure" }, { label: "Achievement" }]} />
